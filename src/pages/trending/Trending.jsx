...
const Trending = () => {
  ...
  return (
    <div className={`font-nunito not-italic text-xl p-[2%] ${toggle ? "bg-dark_black text-white" : "bg-white text-dark_black"}  max-[550px]:text-[5.2vw] max-lap:h-screen max-lap:pt-[4%] max-lap:px-[2%]`}>
