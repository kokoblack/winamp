  ...
  return (
    <div className=" font-nunito not-italic bg-light_black text-white relative ">
      <section className=" flex justify-center items-start ">
        <section className=" basis-[13%] sticky top-0 max-lap:hidden">
          <SideNav />
        </section>

        <section className=" basis-[87%] px-[2%] pt-[2%] max-tablet:px-0 max-tablet:pt-[4%]">
          ...
          <section className="text-sm text-white font-medium max-tablet:text-xxsm mb-[2%] max-tablet:mb-[4%]">
            <button
              ...
              className={`px-[2.5%] py-[1.5%] rounded-xl text-center border-[1px] border-solid border-bright_orange mr-[2%] bg-${
